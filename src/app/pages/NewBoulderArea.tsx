        ...
        <Card className="p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="name">Nome Area Boulder *</Label>
              <Input
                id="name"
                type="text"
                placeholder="Es. Val di Mello, Fontainebleau"
                value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="description"
                placeholder="Descrivi l'area boulder, le caratteristiche, come arrivarci, ecc."
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Label className="text-sm sm:text-base">Posizione Area Boulder *</Label>
              </div>
              <p className="text-xs text-muted-foreground mb-3">
                Cerca l'area boulder o clicca sulla mappa per impostare la posizione
              </p>
              <MapPicker
                latitude={formData.latitude}
                longitude={formData.longitude}
